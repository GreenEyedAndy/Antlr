...
public partial class ExprParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IExprParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="ExprParser.def"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitDef([NotNull] ExprParser.DefContext context) { return VisitChildren(context); }
	/// <summary>
